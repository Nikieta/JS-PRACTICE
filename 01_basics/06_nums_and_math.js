...
//key-value pair thus an object.
console.log(balance);//here the balance is an object of type Number

console.log(typeof(balance.toString()));
//returns string
//there are less properties for Numbers as compared to strings.
...
//returns a string,accepts 1 to 21 sig figs
...
// Number.MAX_SAFE_INTEGER //Maximum integral value which is exact and there is no loss of precision involved.
// Number.MAX_VALUE//Includes integers as well as floating point numbers.Maximum possible integer that can be stored in JavaScript.



//+++++++++++++++++++ Maths +++++++++++++++++++++

console.log(Math)// It is a Math library.Object [Math] {} which contains a lot of properties.
